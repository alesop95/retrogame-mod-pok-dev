...
OGGETTO_DISTRIBUITO = (
    (3, "Biglietto Eone", "Isola Remota", 380, 0, 50, "Rubino", False,
     "Encounters3RSE.cs StaticR"),
    (3, "Biglietto Eone", "Isola Remota", 381, 0, 50, "Zaffiro", False,
     "Encounters3RSE.cs StaticS"),
    (3, "Biglietto Eone", "Isola Remota", 380, 0, 50, "Smeraldo", True,
     "Encounters3RSE.cs StaticE"),
    (3, "Biglietto Eone", "Isola Remota", 381, 0, 50, "Smeraldo", True,
     "Encounters3RSE.cs StaticE"),
    (3, "Carta Mare Antica", "Isola Suprema", 151, 0, 30, "Smeraldo", True,
     "Encounters3RSE.cs StaticE, la fonte annota che fuori dal Giappone non fu distribuita"),
    (3, "Biglietto Magico", "Rocca Ombelico", 249, 0, 70, "Smeraldo", True,
     "Encounters3RSE.cs StaticE"),
    (3, "Biglietto Magico", "Rocca Ombelico", 250, 0, 70, "Smeraldo", True,
     "Encounters3RSE.cs StaticE"),
    (3, "Biglietto Aurora", "Isola Materna", 386, 3, 30, "Smeraldo", True,
     "Encounters3RSE.cs StaticE, forma Velocita'"),
    (3, "Biglietto Magico", "Rocca Ombelico", 249, 0, 70, "Rosso Fuoco e Verde Foglia", True,
     "Encounters3FRLG.cs"),
    (3, "Biglietto Magico", "Rocca Ombelico", 250, 0, 70, "Rosso Fuoco e Verde Foglia", True,
     "Encounters3FRLG.cs"),
    (3, "Biglietto Aurora", "Isola Materna", 386, 1, 30, "Rosso Fuoco", True,
     "Encounters3FRLG.cs StaticFR, forma Attacco"),
    (3, "Biglietto Aurora", "Isola Materna", 386, 2, 30, "Verde Foglia", True,
