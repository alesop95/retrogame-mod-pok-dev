...
| `gba-save-extraction-smeraldo/MAPPA-BOX-SMERALDO.md` | 44k | `gba-save-extraction-smeraldo/tools/emerald_mappa_box.py`, con quattordici figure e una copia `.docx` da stampare, fuori da git |
