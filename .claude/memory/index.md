...
cart-battery-restoration: il track nasce il 2026-09-01 e ha la precedenza sugli altri per una ragione che non è di importanza ma di irreversibilità: è il solo la cui scadenza non è su un calendario ma nella carica residua di una pila saldata nel 1998, e quando finisce il salvataggio cessa di esistere invece di degradarsi. Il runbook è scritto e verificato sulle fonti, in nove sezioni. La risposta alla domanda che ha aperto il track è no: un salvataggio perduto per esaurimento non si recupera, perché la memoria è volatile e i bit non sono danneggiati ma assenti.
