...
| Token utente di Discord | deciso il 2026-08-26 di NON usarlo: il rischio di essere riconosciuti come self-bot e vedersi chiudere l'account non è accettabile. La via resta la copia manuale dei messaggi pertinenti in un file di testo sotto `_notes/fonti/`, che `tools/read-chat-export.py` digerisce comunque | nulla: è una decisione chiusa, e ciò che resta è materiale da procurare |
