...
| smeraldo-save-fix | attivo; tre giri di correzione scritti sulla cartuccia vera e verificati con read-back a hash identico, i primi due il 2026-09-17 su zaino, squadra, simbolo e record della Battle Pike, il terzo il 2026-09-18 sui flag di abilitazione delle isole, e tutti e tre confermati dal controllo in gioco | il quinto giro, che unisce in una sola scrittura la riapertura completa degli eventi delle isole (ADR-066), la Grotta Mutevole con il Succodibacca e la pulizia del deposito PC | nulla di tecnico; restano da scegliere il valore di `VAR_ALTERING_CAVE_WILD_SET` e gli oggetti rari con cui sostituire i sette comuni del deposito, e resta da produrre la squadra del Parco Lotta tutta insieme |
