...
Due linee in parallelo, per direttiva dell'utente del 2026-09-10, restano il criterio. La lettura del corpus ha un residuo di oltre cento post dopo il giro del 2026-09-16, con priorità ai titoli già nominati come pertinenti; i quaranta documenti sulla caccia ai cromatici restano per ultimi. La produzione ha tre fronti aperti: estendere `parco_amici.py` all'uscita di `_notes/lotto-gb/` (prima e seconda generazione, mai fatto per mancanza di tempo), far giudicare dall'esterno gli scambi di quarta e quinta generazione già composti, e le sei voci escluse per macchina nascosta attendono una decisione dell'utente su se perdere la mossa-firma o lasciarle come file. La checklist rigenerata il 2026-09-15 copre 685 specie su 1025 con la nuova fonte degli scambi in gioco Gen3; restano fuori Alcremie a 63 forme e l'asse del sesso (102 specie), che aspettano una decisione su quale fonte prevalga su PKHeX, e gli incontri condizionati, per cui non esiste ancora un generatore.
