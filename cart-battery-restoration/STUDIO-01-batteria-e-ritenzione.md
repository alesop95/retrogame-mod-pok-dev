...
Su come collegarla, il principio fisico non ammette scelta: una pila a bottone non si salda sul corpo, perché il calore necessario la fa sfiatare e nel caso migliore la rovina. Le due vie legittime sono saldare le linguette che chi l'ha prodotta ha già fissato alla pila, oppure saldare un porta-pila e inserirvi una pila nuda.

Fra le due questo progetto ha scelto il porta-pila il 2026-09-01, e la ragione va scritta perché non è di comodità immediata. Saldare le linguette risolve una volta e ripresenta il problema fra quindici anni nella medesima forma, cioè con un saldatore su una scheda invecchiata di altri quindici anni; il porta-pila sposta la saldatura una volta sola e rende ogni sostituzione successiva un gesto a mani nude. Su cartucce che si intende conservare per decenni, il criterio corretto non è il costo del primo intervento ma il numero totale di interventi sul rame, e il porta-pila lo porta a uno.

Ne discende un dettaglio d'acquisto che rovescia la raccomandazione consueta: con il porta-pila la variante a linguette non serve, e servono pile nude del formato corretto, che sono anche più facili da trovare. Va invece verificata prima dell'acquisto una cosa che nessuno pensa a verificare, cioè che l'altezza del supporto stia nello spazio che il guscio della cartuccia lascia sopra la scheda. Una testimonianza del canale segnala anche che la lega con piombo è più facile da lavorare per chi non lo fa di mestiere, e che il flussante aiuta più di quanto si pensi (xukkorz).
