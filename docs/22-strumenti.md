...
## genera-scambio-gen3.py, la sola classe che si compone senza cercare un seme

Gli scambi in gioco di terza generazione non richiedono alcun generatore pseudocasuale: la fonte scrive il valore di personalita', i sei valori individuali, l'identificativo dell'allenatore, il suo sesso, il sesso dell'esemplare, l'abilita' e le statistiche di gara. Ne segue che la fedelta' non e' un argomento ma una identita', e che lo strumento e' un compositore e non un cercatore.

Gli scambi in gioco di terza generazione che la fonte descrive per intero.

tabella              dex   lv personalita  id       soprannome IT nota TradeGift_FRLG       122    5 0x00009CAE   01985    MIMIEN       Abra (Level 5 Breeding) -> Mr. Mime TradeGift_FRLG       124   20 0x498A2E1D   36728    ZYNX         Poliwhirl (Level 20) -> Jynx TradeGift_FRLG        83    3 0x151943D7   08810    CH'DING      Spearow (Level 3 Capture) -> Farfetch'd TradeGift_FRLG       101    3 0x06341016   50298    ESPHERE      Raichu (Level 3) -> Electrode TradeGift_FRLG       114    5 0x5C77ECFA   60042    TANGENY      Venonat (Level 5 Breeding) -> Tangela TradeGift_FRLG        86    5 0x482CAC89   09853    SEELOR       Ponyta (Level 5 Breeding) -> Seel * TradeGift_FR          29    5 0x4C970B89   63184    MS. NIDO     Nidoran♀ TradeGift_FR          30   16 0x00EECA15   13637    NINA         Nidorina * TradeGift_FR         108   25 0x451308AB   01239    MARC         Golduck (Level 25) -> Lickitung  * TradeGift_LG          32    5 0x4C970B9E   63184    MR. NIDO     Nidoran♂ * TradeGift_LG          33   16 0x00EECA19   13637    NINO         Nidorino  * TradeGift_LG         108   25 0x451308AB   01239    MARC         Slowbro (Level 25) -> Lickitung  * TradeGift_RS         296    5 0x00009C40   49562    AGATA        Slakoth (Level 5 Breeding) -> Makuhita TradeGift_RS         300    3 0x498A2E17   02259    SKITIT       Pikachu (Level 3 Viridian Forest) -> Ski TradeGift_RS         222   21 0x4C970B7F   50183    COROSO       Bellossom (Level 21 Oddish -> Gloom -> B TradeGift_E          273    4 0x00000084   38726    DOTS         Ralts (Level 4 Route 102) -> Seedot TradeGift_E          311    5 0x0000006F   08460    PLUSES       Volbeat (Level 5 Breeding) -> Plusle TradeGift_E          116    5 0x0000007F   46285    SEASOR       Bagon (Level 5 Breeding) -> Horsea* TradeGift_E           52    3 0x0000008B   25945    MEOWOW       Skitty (Level 3 Trade)-> Meowth*

19 voci. ok   l'ordine dei valori individuali coincide con quello dello strato di terza generazione ok   la velocita' sta al quarto posto e non al sesto, che e' la trappola di questa classe ok   i sei valori individuali si leggono nell'ordine della fonte ok   negativo: un insieme con meno di sei valori non si completa a caso ok   negativo: una proprieta' assente non produce valori individuali a zero ok   il codice del luogo si legge dalla tabella invece di essere trascritto ok   negativo: le abilita' note sono due e non si indovina una terza
