...
# GBAtemp, correzione dei salvataggi in Virtual Console

https://gbatemp.net/threads/tutorial-fix-all-save-problems-for-pokemon-games-vc-gba.433266/
...
Livello 4 di affidabilità secondo la gerarchia di [[SOURCES]]. Track serviti: 3DS. La mappa di tutte le fonti e delle loro relazioni è [[index-fonti]].
