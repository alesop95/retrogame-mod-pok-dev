...
conferma: "[[frlg-ldn-trade]]"
documenta: "[[ldnd]]"
---

# Pokemon Multiplayer Research, canali di supporto
...
- conferma in modo indipendente [[frlg-ldn-trade]]
- documenta il funzionamento di [[ldnd]]

## Contesto

Livello 4 di affidabilita' secondo la gerarchia di [[SOURCES]]. Track serviti: LDN, BRI. La mappa di tutte le fonti e delle loro relazioni e' [[index-fonti]].
