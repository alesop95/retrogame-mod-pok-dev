...
## 26. Il settimo difetto: un valore predefinito ragionevole su un campo ignoto

La correzione del livello di incontro ha reso conformi dieci delle trentacinque uova contestate, e la partizione delle restanti venticinque ha indicato la causa senza bisogno di un altro rapporto: erano tutte e sole le voci che la tabella dichiara per più titoli insieme.

La tabella nomina il gioco di origine con una sigla, e la sigla può essere singola oppure multipla. Il progetto teneva una corrispondenza fra sigle e codici che comprendeva le singole e una sola delle multiple, e la interrogava con un valore predefinito: una sigla ignota restituiva il codice del primo titolo della generazione. Le venticinque voci dichiarate per gruppi di titoli cadevano dunque su quel valore, e portavano come gioco di origine un titolo che il loro evento non contemplava. Il verificatore non poteva riconoscere il dono e le rifiutava tutte.

Il difetto è della classe che questo progetto incontra più spesso, e vale enunciarne la forma perché ricorre: un valore predefinito ragionevole su un campo che non si conosce non somiglia a un errore. Se il predefinito fosse stato assurdo, il difetto si sarebbe visto alla prima corsa; essendo un titolo esistente della generazione giusta, ha prodotto venticinque esemplari plausibili e sbagliati. La correzione non è quindi soltanto aggiungere le sigle mancanti, che sarebbe rimediare a questo caso: è togliere il valore predefinito, cosicché una sigla ignota solleva invece di ricevere un codice.
...
## 28. Il traguardo: centosettantadue su centosettantatre, e nessuno contestato

Il 2026-09-02, dopo la correzione del nome dell'allenatore delle uova, il lotto è stato ricaricato nelle sei scatole di un salvataggio vuoto di terza generazione e le due scatole che restavano contestate sono state rilette. Sono pulite. Nessuna posizione di nessuna delle sei scatole porta il contrassegno di non conformità.

Vale precisare che cosa questo dimostri, perché il contrassegno è un segno piccolo e la conclusione che ne discende è grande. Quel contrassegno riflette l'esito dell'analisi completa di legittimità e non di un controllo parziale, quindi la sua assenza su una posizione equivale a un rapporto senza rilievi sull'esemplare che vi sta. Ne segue che ogni voce del catalogo che il progetto sa produrre è stata giudicata da una implementazione indipendente, e nessuna è contestata. La sola voce che resta fuori è quella distribuita dal canale televisivo, che impiega un generatore pseudocasuale differente e che il progetto ha dichiarato fuori portata prima di cominciare, non dopo aver fallito.

### Il conto della campagna

La campagna di verifica esterna è cominciata il 2026-09-01 con un esemplare solo e si chiude il 2026-09-02 con centosettantadue. Ha prodotto otto difetti distinti, tutti corretti e tutti riverificati dopo la correzione, e vale elencarli di seguito perché insieme dicono dove stia la difficoltà reale in un lavoro di questo genere.

Il contrassegno dell'incontro fatidico, che era il campo che il generatore stesso segnalava come dubbio. Il bit dell'abilità su una specie che ne ha una sola, che riguardava cinquantanove esemplari. Il vincolo che lega il seme al bit del sesso dichiarato. Il troncamento di un nome che riempie esattamente il proprio campo, che riguardava settantaquattro esemplari. Il fiocco Nazionale che due voci della tabella dichiarano e che non estraevamo. Il livello di incontro delle uova, che il quinto argomento del costruttore della fonte lascia a zero. Il gioco di origine delle voci dichiarate per più titoli, che cadeva su un valore predefinito invece di essere derivato. E il nome dell'allenatore delle uova, dove avevo preso per specifica il comportamento di un programma in un caso che quel programma non aveva previsto.

Nessuno di questi otto riguarda il generatore pseudocasuale. Quella era la parte che il progetto aveva studiato per giorni, con la ricerca inversa del seme, la verifica su duecentonove vettori conservati e la lettura del codice della fonte riga per riga, ed era giusta dal principio: il solo difetto che vi si è trovato, la mutazione antilucente, non era un errore di calcolo ma un ramo che mancava, e scoprirlo ha reso il modello completo invece di correggerlo. Tutti e otto i difetti stanno nei campi di contorno, cioè contrassegni, nomi, livelli, codici di versione e fiocchi, e sei degli otto sono un valore predefinito sbagliato oppure un campo che la tabella dichiarava e noi non leggevamo.

### Dove sta la difficoltà, e perché non dove sembra

La lezione è netta e vale oltre questo lavoro. La difficoltà percepita di un problema si concentra sulla sua parte formalmente complessa, e lo sforzo la segue: qui la parte complessa era il generatore pseudocasuale, e ha ricevuto giorni di studio, prove con controlli negativi e una verifica su un corpus di vettori storici. La difficoltà reale si è concentrata invece nella parte che sembrava non averne, cioè nel copiare correttamente una dozzina di campi da una tabella.

La ragione non è che quei campi siano difficili, ma che nessuno li guarda. Un errore nel generatore si manifesta come un valore di personalità che non torna, cioè come un fallimento visibile su un vettore di prova, e una suite di prove lo intercetta il giorno stesso in cui viene introdotto. Un errore in un campo di contorno si manifesta come un esemplare perfettamente plausibile, e la sua scoperta richiede qualcuno che lo giudichi con criteri che noi non abbiamo scritto. Ne segue che l'investimento in prove interne va dove il fallimento è visibile, e l'investimento in giudizio esterno va dove non lo è, e i due non sono sostituibili l'uno all'altro: la suite di prove di questo progetto era verde durante tutti e otto i difetti, e lo era legittimamente, perché verificava ciò che sapevamo verificare.

### Che cosa resta da rifare, e perché non è un difetto

Sessanta voci della tabella prendono l'identificativo dell'allenatore dal salvataggio che le riceve, e il lotto attuale porta per esse un identificativo di esempio. Poiché la lucentezza dipende dalla somma esclusiva fra i due identificativi dell'allenatore e le due metà del valore di personalità, quei sessanta esemplari cambieranno seme e valore di personalità quando si userà l'identificativo vero, cioè quando esisterà un salvataggio di destinazione da cui leggerlo.

Questo non invalida la verifica appena conclusa, e la ragione va detta perché è la stessa che regge tutta la strategia di prova del progetto. La verifica esercita rami di codice e non byte particolari: il ramo che compone il valore di personalità per il metodo delle uova, la tabella dei caratteri che scrive un nome latino, la formula che deriva il bit dell'abilità. Cambiare l'identificativo dell'allenatore cambia i byte in uscita e non il ramo percorso, quindi il lotto rigenerato con l'identificativo vero percorrerà gli stessi rami già giudicati. Ciò che andrà rifatto è la rilettura di massa, che costa poche schermate, non lo studio.

## Verificato il 2026-09-15: settantatré voci su centosettantadue non sono renderizzabili su una cartuccia non giapponese, e non è un difetto del lotto

La domanda è nata da una sessione sul lettore di cartucce, non dal generatore: prima di scrivere un esemplare di questo lotto su una cartuccia italiana vera, va sapputo se il suo nome si vedrà come è stato concepito o come un errore plausibile.

`pokebridge/charmap.py` lo dichiara nel proprio commento, e non è una scoperta di oggi ma una regola già scritta: in generazione 3 un byte non rende un carattere ma due, e quale dei due si vede dipende dalla lingua del gioco che legge, non dalla lingua dell'esemplare. Il byte 0x6F rende una sillaba katakana su un gioco giapponese e una lettera accentata su uno internazionale. Scrivere un nome giapponese con la tabella internazionale non produce un errore ma un nome plausibile e sbagliato, che è esattamente il modo di sbagliare che quel modulo esiste per prevenire in scrittura, e che nessuno previene in lettura su una console vera: il gioco disegna sempre con la propria tabella, a prescindere da quella con cui l'esemplare era stato scritto.

Contato sui centosettantadue file di `_notes/lotti/lotto-eventi/`, leggendo il byte di lingua alla posizione 0x12 di ciascuno: settantatré sono giapponesi, cinquantanove inglesi, dieci ciascuno per francese, italiano, tedesco e spagnolo. Le cinque lingue non giapponesi condividono la stessa tabella internazionale, quindi un esemplare inglese, francese, tedesco o spagnolo si legge correttamente su una cartuccia italiana esattamente come uno italiano: il rischio non è "lingua diversa dalla mia cartuccia", è specificamente "lingua giapponese", e riguarda quarantadue voci su cento, non la metà del lotto come un conteggio superficiale sulla sola quota giapponese (settantatré su centosettantadue) farebbe temere.

La conseguenza operativa per la prova su hardware reale: la prima scrittura su una cartuccia posseduta va scelta fra le novantanove voci non giapponesi, non a caso fra le centosettantadue. Le settantatré giapponesi restano perfettamente valide come file e come dato storico, e diventano un problema soltanto se scritte su una cartuccia non giapponese: la correzione, se un giorno servisse davvero scriverle su hardware non giapponese, non è nel generatore ma nel sapere quali esemplari possono viaggiare su quale console.

### La prova scelta, e il suo esito sul file prima dell'hardware

Il 2026-09-15 è stato scelto l'esemplare 059, il Pikachu del decennale in lingua italiana (una delle dieci voci italiane del lotto), caricato con `tools/carica-lotto-gen3.py` nella scatola 1 del backup verificato del Rubino di prova. Il rapporto sui box generato da PKHeX (`_notes/salvataggi/prove/prova-iniezione-rubino/Box Data Dump round1.csv`) lo dichiara `Legal: True`, `OTLang: Italian`, `OT: 10ANNI`, `EncounterType: Event Gift`, coerente con l'esemplare storico che il progetto già conosce. Gli altri sei esemplari nel file, cioè la squadra vera della partita (Mudkip e cinque incontri selvatici, allenatore ALESSIO), risultano a loro volta tutti `Legal: True`: l'iniezione ha toccato solo la scatola, la squadra in corso non è stata alterata.

È la prima volta che un esemplare composto da questo progetto viene giudicato dal verificatore dentro un salvataggio letto da una cartuccia vera invece che da un contenitore sintetico, e il giudizio è pulito. Il passo che resta, cioè la scrittura sulla cartuccia con FlashGBX e il read-back byte per byte, non è più una verifica del metodo di generazione: è una verifica della catena hardware, che è governata da `hardware-and-perimeter.md` e non da questo documento.
