...
| il giudizio di conformità di ogni lotto su disco, ripetibile e legato all'impronta dei file | `giudizi-pkhex-core.json`, generato da `tools/pkhex-giudica`, in questa cartella; i giudizi fatti a mano stanno in `giudizi-esterni.json` |
