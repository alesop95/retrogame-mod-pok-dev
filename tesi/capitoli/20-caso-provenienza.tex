...
Le voci da distribuzione soggette alla scadenza sono $2686$; le specie distinte che esse portano sono $336$. Il rapporto è di circa otto a uno, e la causa è duplice: la medesima distribuzione compare come voce distinta per ogni regione e ogni lingua in cui fu effettuata, e le generazioni distribuirono in larga parte le medesime specie.

Le due grandezze misurano obiettivi diversi. Se l'obiettivo è il catalogo, cioè la casella accesa, il lavoro utile è di $336$ unità e ogni voce oltre la prima per ciascuna specie è ridondante. Se l'obiettivo è la collezione delle distribuzioni nella loro identità storica, il lavoro è di $2686$ unità e nessuna voce è ridondante. Poiché il primo anello della catena di trasferimento muove sei esemplari per sessione, i due obiettivi non differiscono per fatica ma per scala, e la scelta fra essi determina se il fattore limitante sia la produzione o il trasporto. Un progetto che non la faccia esplicitamente la fa comunque, per accumulo, e la scopre quando il tempo è finito.
